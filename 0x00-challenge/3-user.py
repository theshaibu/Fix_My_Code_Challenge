#!/usr/bin/python3
"""
User Model: Defines a simple user model with unique ID and hashed password.
"""
import hashlib
import uuid
...
if __name__ == '__main__':
    ...
    if not user_1.is_valid_password(u_pwd):
        print("is_valid_password should return True for the correct password")

    if user_1.is_valid_password("Fakepwd"):
        print("is_valid_password should return False for an incorrect password")

    if user_1.is_valid_password(None):
        print("is_valid_password should return False when comparing with None")

    if user_1.is_valid_password(89):
        print("is_valid_password should return False when comparing with an integer")

    if user_2.is_valid_password("No pwd"):
        print("is_valid_password should return False when no password is set")
